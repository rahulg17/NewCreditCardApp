...
.post-content {
	background-image:
		url(http://vm-dev.eastus.cloudapp.azure.com:8080/CreditCardApp/Building_image.jpg);
}
</style>
<script>
...
<body background="Building_image.jpg">
	...
	<form id="submit-form" name="Name Input Form" action="controller"
		method="post">
		...
		<!-- Enable Credit card app 	
			...
			<tr>
				<td style="color: brown;" width="100%"><b><p>
							<font size="3">PERSONAL DETAILS </font>
						</p></b></td>
			...
			<tbody>
				<tr>
					<td>TITLE</td>
					<td><select id="title" name="titleCust"
						style="background-color: white; color: black;">
				...
				<tr>
					...
					<td><input type="text" name="passNumber" value=""
						style="background-color: white; color: black;" /></td>
				</tr>
				<tr>
					<td>NATIONALITY</td>
				...
				<p></p>
				<tr>
					<td style="color: brown;"><b><p>
								<font size="3">ADDRESS LINE</font>
							</p></b></td>
			...
			<tbody>
				...
				<tr>
					<td>ADDRESSS LINE</td>
					<td><input type="text" name="addLine" value=""
						style="background-color: white; color: black;"></td>
				</tr>
				<tr>
					<td>CITY</td>
				...
				<tr>
					<td style="color: brown;"><b><p>
								<font size="3">OCCUPATION DETAILS </font>
							</p></b></td>

				</tr>
				<tr>
					<td>OCCUPATION</td>
					<td><select id="occupation" name="occupation"
						style="background-color: white; color: black;">
				...
				<tr>
					<td>ANNUAL INCOME</td>
					<td><input type="text" name="anualIncome" value=""
						style="background-color: white; color: black;"></td>
				</tr>
			</tbody>
		...
		<table width=200 align="center">
			<td>
				...
				<a class="fancy_button" id="submit-button"
				href="javascript:submitFunction();" runat="server"
				style="text-decoration: none;" target="_blank"><span
					style="background-color: #FF0000; width: 100px">SUBMIT</span></a>
			</td>
		</table>
	</form>
</body>
